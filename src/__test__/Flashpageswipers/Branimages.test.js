...
import BrandbargainSwiper from '../../Components/Flashpage/Swipers/Brandbargainswiper';
...
describe('BrandbargainSwiper', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it('should render all images in the Swiper correctly', () => {
    render(<BrandbargainSwiper />);
  ...
  it('should apply correct image width for lg screen size', () => {
